                ...
                <div class="card-body">
                    ...
                    <form action="{{route('category.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" require value="{{$category->title}}" id="slug" onkeyup="ChangeToSlug()" placeholder="..." name="title">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slug</label>
                            <input type="text" class="form-control" require value="{{$category->slug}}" id="convert_slug" placeholder="..." name="slug">
                        </div>
                        <div class="form-group">
