    ...
    <link rel="shortcut icon" href="{{ asset('frontend/storage/images/TL2fjkL38e_1610595242.jpg') }}" type="image/x-icon">
    ...
    <link href="{{ asset('frontend/css/default.css') }}" id="style_theme" rel="stylesheet" type="text/css"/>
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse">
        ...
        <script src="frontend/js/wow.js" type="text/javascript"></script>
        <script src="frontend/js/reveal-animate.js" type="text/javascript"></script>
        <!-- END: CORE PLUGINS -->

        <!-- BEGIN: LAYOUT PLUGINS -->
        <script src="frontend/js/magnific.js" type="text/javascript"></script>
        <script src="frontend/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
        ...
        <script src="frontend/js/jquery.smooth-scroll.js" type="text/javascript"></script>
        <script src="frontend/js/js.cookie.js" type="text/javascript"></script>
        <!-- END: LAYOUT PLUGINS -->

        <!-- BEGIN: THEME SCRIPTS -->
        <script src="frontend/js/components.js" type="text/javascript"></script>
        <script src="frontend/js/app.js" type="text/javascript"></script>
        <script src="frontend/js/bootbox.min.js" type="text/javascript"></script>
        <script>
